...
class TestBackend(unittest.TestCase):
    ...
    def testMakeMap(self, mock_db, mock_db_filtered):
        ...
        response = self.client.post('https://data-analyzer.onrender.com/make-map', json=data)
    ...
    def testOrbitCalculations(self, mock_db):
        ...
        response = self.client.get('https://data-analyzer.onrender.com/orbit-calculations')
        self.assertEqual(response.status_code, 200)
