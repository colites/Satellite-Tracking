...
from Components.DataAnalyzer.src.data_analyzer import create_app
...
class TestBackend(unittest.TestCase):
    ...
    @patch('Components.schemas_queries.getSatellitesFiltered')
    @patch('Components.schemas_queries.getAllSatellites')
